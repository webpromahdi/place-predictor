...
PlacePredictor is a machine learning-based student placement prediction system that predicts whether a student is likely to be placed or not using a trained Naive Bayes model. The system takes academic and employability-related information through a Streamlit web interface and provides placement prediction, probability score, AI-based explanation, skill improvement suggestions, and an examiner dashboard with model comparison and EDA visualizations.
